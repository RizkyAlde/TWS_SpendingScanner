...
app = FastAPI(title="Spending Scanner Prediction")
...
@app.post("/predict/{category}",  tags=["Prediksi Pengeluaran Bulanan"], description=" Pilihan kategori : all, electronics, clothing, books, furniture, games, foods, health, traffic, other")
